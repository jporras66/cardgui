...
//
	public CardFrm(Composite parent) {
		...
		lblCard.setFont(SWTResourceManager.getFont("Calibri", 9, SWT.NORMAL));
		...
		lblExpdate.setFont(SWTResourceManager.getFont("Calibri", 9, SWT.NORMAL));
		...
		lblService.setFont(SWTResourceManager.getFont("Calibri", 9, SWT.NORMAL));
		...
		txtcardpanNumber.setFont(SWTResourceManager.getFont("Calibri", 9, SWT.NORMAL));
		txtcardpanNumber.setBounds(12, 46, 135, 21);

		txtcardExpDate = new Text(groupcard, SWT.BORDER);
		txtcardExpDate.setFont(SWTResourceManager.getFont("Calibri", 9, SWT.NORMAL));
		txtcardExpDate.setBounds(152, 46, 46, 21);

		txtcardServCode = new Text(groupcard, SWT.BORDER);
		txtcardServCode.setFont(SWTResourceManager.getFont("Calibri", 9, SWT.NORMAL));
		...
		btnVisaPvv.setFont(SWTResourceManager.getFont("Calibri", 9, SWT.NORMAL));
		...
		btnIbmOffset.setFont(SWTResourceManager.getFont("Calibri", 9, SWT.NORMAL));
		...
		txtcarddki.setFont(SWTResourceManager.getFont("Calibri", 9, SWT.NORMAL));
		txtcarddki.setBounds(51, 38, 34, 21);

		lblPvvoffset = new Label(pinValidationType, SWT.NONE);
		lblPvvoffset.setText("pvv/offset");
		lblPvvoffset.setFont(SWTResourceManager.getFont("Calibri", 9, SWT.NORMAL));
		...
		txtcardPvv.setFont(SWTResourceManager.getFont("Calibri", 9,SWT.NORMAL));
		...
		btnIsopinblock0.setFont(SWTResourceManager.getFont("Calibri", 9, SWT.NORMAL));
		...
		btnIsopinblock3.setFont(SWTResourceManager.getFont("Calibri", 9, SWT.NORMAL));
		...
		lblPvk.setFont(SWTResourceManager.getFont("Calibri", 9, SWT.NORMAL));
		...
		lblNewLabel_1.setFont(SWTResourceManager.getFont("Calibri", 9, SWT.NORMAL));
		...
		txtkeyCvk2.setFont(SWTResourceManager.getFont("Calibri", 9, SWT.NORMAL));
		txtkeyCvk2.setEditable(false);
		txtkeyCvk2.setBounds(20, 162, 275, 21);

		txtkeyDateformatCvv2 = new Text(groupkey, SWT.BORDER);
		txtkeyDateformatCvv2.setFont(SWTResourceManager.getFont("Calibri", 9, SWT.NORMAL));
		...
		lblZpkForPinblock.setFont(SWTResourceManager.getFont("Calibri", 9, SWT.NORMAL));
		...
		txtkeyZpk.setFont(SWTResourceManager.getFont("Calibri", 9, SWT.NORMAL));
		txtkeyZpk.setEditable(false);
		txtkeyZpk.setBounds(20, 222, 275, 21);

		txtkeyPinblockFormat = new Text(groupkey, SWT.BORDER);
		txtkeyPinblockFormat.setFont(SWTResourceManager.getFont("Calibri", 9, SWT.NORMAL));
		...
		lblPin.setFont(SWTResourceManager.getFont("Calibri", 9, SWT.NORMAL));
		lblPin.setBounds(new Rectangle(0, 0, 0, 16));
		lblPin.setBounds(12, 25, 32, 17);
		lblPin.setText("pin");

		txtrspin = new Text(result, SWT.BORDER);
		txtrspin.setFont(SWTResourceManager.getFont("Calibri", 9, SWT.NORMAL));
		...
		txtdrsdki.setFont(SWTResourceManager
				.getFont("Calibri", 9, SWT.NORMAL));
		txtdrsdki.setBounds(86, 46, 33, 21);

		Label lblCvvcvc = new Label(result, SWT.NONE);
		lblCvvcvc.setFont(SWTResourceManager.getFont("Calibri", 9, SWT.NORMAL));
		...
		txtrscvv.setFont(SWTResourceManager.getFont("Calibri", 9, SWT.NORMAL));
		txtrscvv.setBounds(125, 46, 43, 21);

		lblCvv = new Label(result, SWT.NONE);
		lblCvv.setFont(SWTResourceManager.getFont("Calibri", 9, SWT.NORMAL));
		...
		lblIcvv.setFont(SWTResourceManager.getFont("Calibri", 9, SWT.NORMAL));
		...
		lblClearPinblock.setFont(SWTResourceManager.getFont("Calibri", 9,SWT.NORMAL));
		...
		txtrsclearpinblock.setFont(SWTResourceManager.getFont("Calibri", 9,SWT.NORMAL));
		txtrsclearpinblock.setBounds(12, 107, 135, 21);

		lblEncryptedPinblock = new Label(result, SWT.NONE);
		lblEncryptedPinblock.setFont(SWTResourceManager.getFont("Calibri", 9, SWT.NORMAL));
		...
		txtrsencryptedpinblock.setFont(SWTResourceManager.getFont("Calibri", 9, SWT.NORMAL));
